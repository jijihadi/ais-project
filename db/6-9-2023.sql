...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2023 at 03:00 PM
...
INSERT INTO `consents` (`id`, `form_id`, `agree`, `verification`, `patient_id`, `guardian_id`, `employee_id`, `patient_sign`, `guardian_sign`, `employee_sign`, `inputdate`, `inputby`) VALUES
...
(2, 1, '\"Dengan menandatangani dokumen ini berarti saya telah memahami dan menyetujui semua ketentuan tersebut.\r\n                                            Jika yang memberikan tanda tangan bukan pasien yang bersangkutan, maka penandatangan menjamin bahwa ia mendapat kuasa dari pasien dan sah mewakili pasien.\"', '[\"Diagnosis penyakit saya tidak boleh diinformasikan termasuk keluarga inti\"]', 2, 1, 2, '12309152-signature-pasien-2023-09-05-15-57-44.png', '12309152-signature-wali-2023-09-05-15-57-44.png', '12309152-signature-petugas-2023-09-05-15-57-44.png', '2023-09-05 08:57:44', '1'),
(3, 1, '\"Dengan menandatangani dokumen ini berarti saya telah memahami dan menyetujui semua ketentuan tersebut.\r\n                                            Jika yang memberikan tanda tangan bukan pasien yang bersangkutan, maka penandatangan menjamin bahwa ia mendapat kuasa dari pasien dan sah mewakili pasien.\"', '[\"Diagnosis penyakit saya tidak boleh diinformasikan kecuali keluarga inti\"]', 2, 1, 2, '12309152-signature-pasien-2023-09-05-16-36-40.png', '12309152-signature-wali-2023-09-05-16-36-40.png', '12309152-signature-petugas-2023-09-05-16-36-40.png', '2023-09-05 09:36:40', '1');
...
(9, '091239081233', 'Pati Surangkat', '', 'S.Kep.', '2023-09-06', 'Striker', '08123131212', 'a@a.com', 9, '2023-09-05 09:41:51', NULL),
(10, '12393105214', 'Rori', '', 'S.Kep.', '2023-09-14', 'Back Sayap', '081231313131', 'man@man.com', 10, '2023-09-05 11:09:10', NULL);
...
(6, 'Riyan anjing', 'ayah', '<p>apa sih sok kenal riyan&nbsp;</p>', '081231318793817', 7, '2023-09-06 12:44:22', '', NULL, NULL);
...
(7, '0012399123', 'Sibuk', 'P', 'gatau anjing', '2023-09-10', '<p>pantek</p>', '081231913131', '2023-09-06 12:44:22', '', NULL, NULL);
...
(9, '091239081233', '9e3669d19b675bd57058fd4664205d2a', 'Pati Surangkat', 1, '2023-09-05 09:41:51', NULL),
(10, '12393105214', '51b6c65f529f9e5c074d786234641581', 'Rori', 1, '2023-09-05 11:09:10', NULL);
